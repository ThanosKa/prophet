...
type ApiState<T> = {
  ...
  error?: string
  data?: T
} // Can be loading=true AND have data!
```
...
function ChatList({ messages }: { messages: readonly Message[] }) {
